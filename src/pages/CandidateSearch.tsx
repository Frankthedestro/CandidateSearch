...
// This component handles the candidate search functionality
// It fetches candidates from GitHub, displays them, and allows the user to accept or reject candidates
const CandidateSearch = () => {
  ...
  //returns the candidate cards recieved from the API
  return (
